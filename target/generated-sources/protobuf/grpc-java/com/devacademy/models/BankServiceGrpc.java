...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.devacademy.models.BalanceCheckRequest,
      com.devacademy.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.devacademy.models.BalanceCheckRequest.class,
      responseType = com.devacademy.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.devacademy.models.BalanceCheckRequest,
      com.devacademy.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.devacademy.models.BalanceCheckRequest, com.devacademy.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.devacademy.models.BalanceCheckRequest, com.devacademy.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.devacademy.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.devacademy.models.Balance.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.devacademy.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.devacademy.models.Balance> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.devacademy.models.BalanceCheckRequest,
                com.devacademy.models.Balance>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public com.devacademy.models.Balance getBalance(com.devacademy.models.BalanceCheckRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.devacademy.models.Balance> getBalance(
        com.devacademy.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.devacademy.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.devacademy.models.Balance>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.devacademy.models.BankServiceOuterClass.getDescriptor();
    }
